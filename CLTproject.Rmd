...
The first standard deviation was 41 and now on the 5th one its getting cut down to a third of that total which we got 13.68 but we expect
`r sd(my1000$k3)`
...
The standard deviation is now a quarter of what it was which is 10.31 and we expected `r sd(my1000$k4)`
...
The standard deviation is now one fifth of what it was in the beginning we got 8 and we expected`r sd(my1000$k5)` and it is only off by a little bit.
